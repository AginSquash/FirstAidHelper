...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushFAH_button.setGeometry(QtCore.QRect(97, 165, 180, 180))
        font = QtGui.QFont()
        font.setKerning(True)
        self.pushFAH_button.setFont(font)
        self.pushFAH_button.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pushFAH_button.setAccessibleDescription("")
        ...
        self.pushFAH_button.setIconSize(QtCore.QSize(170, 170))
        self.pushFAH_button.setShortcut("")
        self.pushFAH_button.setCheckable(False)
        self.pushFAH_button.setAutoExclusive(False)
        self.pushFAH_button.setAutoDefault(False)
        self.pushFAH_button.setDefault(False)
